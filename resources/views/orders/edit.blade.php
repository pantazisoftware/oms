<x-app-layout :title="'Edit Order'">
    <x-slot name="header">
        ...
        <a href="#" class="inline-flex space-x-2 items-center px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-indigo-100 text-sm font-medium hover:text-white hover:shadow rounded">
