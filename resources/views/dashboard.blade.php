                ...
                <div class="p-6 text-gray-900">
                   ...
                   <div class="grid grid-cols-1 gap-6 md:grid-cols-3 columns-3">
                    <div class="inline-flex items-center flex-1 p-6 space-x-6 bg-white rounded-lg shadow-lg">
                                ...
                                <div>
                                    <h5 class="text-xs font-medium text-gray-500">Orders, Last 7 Days</h5>
                                    <p class="pt-1 text-3xl font-bold">13</p>
                                </div>
                    ...
                    <div class="inline-flex items-center flex-1 p-6 space-x-6 bg-white rounded-lg shadow-lg">
                                ...
                                <div>
                                    <h5 class="text-xs font-medium text-gray-500">Income, Last 7 Days</h5>
                                    <p class="pt-1 text-3xl font-bold">1450 lei</p>
                                </div>
                    ...
                    <div class="inline-flex items-center flex-1 p-6 space-x-6 bg-white rounded-lg shadow-lg">
                                ...
                                <div>
                                    <h5 class="text-xs font-medium text-gray-500">Orders, In 7 Days</h5>
                                    <p class="pt-1 text-3xl font-bold">8</p>
                                </div>
