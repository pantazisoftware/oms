        ...
        <div class="mx-auto max-w-7xl">
            <div class="overflow-hidden sm:rounded-lg">
                <div class="p-3 text-gray-900 sm:p-0" >
                    <div>
                        <form action="" class="flex flex-row items-center justify-center w-full mx-auto overflow-hidden bg-white border border-gray-100 rounded-lg md:w-6/12">
                            <label for="search" class="w-full">
                            <input type="text" name="search" id="search" class="flex-1 w-full h-full p-3 text-sm bg-transparent border-0 focus:outline-none" placeholder="Search client by name or phone...">
                            </label>
                            <div id="hide" class="border-l border-gray-200">
                                <label for="date">
                                    <input type="date" name="date" id="date" class="w-40 h-full p-3 text-sm bg-transparent border-0 click:outline-none focus:outline-none" placeholder="Search by date...">
                                </label>
                            </div>
                            <button class="flex-shrink px-4 py-3 overflow-hidden text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600" type="submit">Search</button>
                        </form>
                    </div>
